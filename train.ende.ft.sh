...
tgt_dict=`pwd`/data-bin/wmt16_en_de_bpe32k/dict.de.txt
...
CUDA_VISIBLE_DEVICES=0,1,2,3  python3 train.py --ddp-backend=no_c10d  data-bin/wmt16_en_de_bpe32k \
	  --arch transformer_wmt_en_de  --share-all-embeddings --fp16 \
	    --optimizer adam --adam-betas '(0.9, 0.98)' --clip-norm 0.0 \
         ...
         --adaptive-training --dict-file $tgt_dict --adaptive-method 'exp' --adaptive-T 1.75  --weight-drop 0.3   --criterion label_smoothed_cross_entropy --label-smoothing 0.1 --weight-decay 0.0\
